...
import PineMath from './namespaces/PineMath';
import { PineRequest } from './namespaces/PineRequest';
...
export class Context {
    ...
    public taState: unknown = {}; // State for incremental TA calculations
    public useTACache = false;

    public NA: number = NaN;
